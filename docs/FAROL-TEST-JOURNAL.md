...
progress, fixed problems, lessons, and behaviors to watch during the live
Hermes/Cristalina test.

It must not be treated as store truth, owner authority, product memory, or
evidence by Cristalina.
