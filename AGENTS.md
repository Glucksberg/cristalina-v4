...
- 2026-04-27: Runtime bridges only stay operationally legal when convenience commands preserve the same store root, checkpoint identity, artifact uniqueness, and explicit authority boundaries as the underlying core workflows.
