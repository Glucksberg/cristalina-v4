...
export function helpText(): string {
  return [
    ...
    "  audit memory [--date YYYY-MM-DD] [--timezone IANA] [--since ISO] [--until ISO] [--query TEXT] [--runtime openclaw|hermes] [--include-runtime-surfaces] [--hermes-root PATH] [--config PATH] [--store-root PATH]",
    "  smoke dual-runtime",
